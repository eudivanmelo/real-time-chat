    ...
    return (
        <div className="flex gap-3 items-center">
            ...
            <div className="space-y-1">
                <div className={`max-w-xs sm:max-w-md py-2 px-3 ${data.from_user.id === user?.id ? "bg-primary rounded-l-md rounded-ee-md text-primary-foreground" : "bg-secondary rounded-r-md rounded-es-md text-slate-700 dark:text-slaet-200"}`}>
                ...
                <div className="flex items-center justify-between px-1 gap-6 select-none">
                    <small className="text-slate-600 dark:text-slate-400 font-semibold">
                        {dayjs(data.create_at).format('DD/MM/YYYY [às] HH:mm')}
                    </small>
