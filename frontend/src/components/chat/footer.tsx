...
export const Footer = ({ onSendMessage }: Props) => {
    ...
    const handleStartRecording = async () => {
        ...
        if ("MediaRecorder" in window){
            ...
            toast.error("Seu navegador não tem suporte para gravação de audio!", {position: 'top-center'})
        }
            ...
            <div className="flex items-center gap-4 border-t bg-slate-100/80 dark:bg-slate-900/80 px-8 py-2.5">
                {isRecording ?
                    <div className="flex items-center gap-5">
                        ...
                        <Button className="ml-5" size="sm" title="Enviar mensagem de voz" onClick={handleSendRecording}>
